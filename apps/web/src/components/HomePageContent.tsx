...
const categories: CategoryTile[] = [
  { key: "all", value: "all", label: "All", icon: "bi-grid", href: "/properties" },
  { key: "pg", value: "PG", label: "PG", icon: "bi-building", href: "/pg" },
  { key: "girls-pg", value: "GIRLS_PG", label: "Girls PG", icon: "bi-person-hearts", href: "/girls-pg" },
  { key: "boys-pg", value: "BOYS_PG", label: "Boys PG", icon: "bi-person-check", href: "/boys-pg" },
  { key: "room", value: "ROOM", label: "Rooms", icon: "bi-door-open", href: "/rooms" },
  { key: "flat", value: "FLAT", label: "Flats", icon: "bi-houses", href: "/flats" },
  { key: "homestay", value: "HOMESTAY", label: "Homestay", icon: "bi-house-heart", href: "/homestay" },
  { key: "hostel", value: "HOSTEL", label: "Hostel", icon: "bi-buildings", href: "/hostel" }
];
...
export function HomePageContent({ initialCategory = "all" }: HomePageProps = {}) {
  ...
  const [category, setCategory] = useState<"all" | PropertyCategory>(initialCategory);
